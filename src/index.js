 ...
 */
var FACTS = [
    "Children have more tast buds than adaults",
    "Baboons were once trained by Egyptians to wait on tables",
    "Most Koala bears an sleep up to 22 hours a day.",
    "Queen Isabella the first of Spain, who funded Columbus' voyage across the ocean, claimed to have only bathed twice in her life",
    "People don't sneeze when they are asleep because teh nerves involved in the sneeze reflex are also resting",
...
Fact.prototype.intentHandlers = {
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        response.ask("You can say tell me a random fact, or, you can say exit... What can I help you with?", "What can I help you with?");
    },
